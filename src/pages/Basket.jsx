...
const Basket = ({item, setItem, report, useReport}) => {
    const filterItem = (id) => {
    ...
    return (
        <div className="cart">
            <div className="cart__top">
                ...
                <div className="cart__clear" onClick={() => setItem([])}>
                    ...
                    {/*<span onClick={() => setItem([])}>Очистить корзину</span>*/}
                </div>
            </div>
            <div className="cart__info info">
                <p className='info__title'>Контактные данные: </p>
                <div className="info__form">
                    <input className='info__name input' type="text" placeholder='Имя'
                           onChange={(e) => setName(e.target.value)} value={name} required/>
                    <input className='info__surname input' type="text" placeholder='Фамилия'
                           onChange={(e) => setSurname(e.target.value)} value={surname} required/>
                    <input className='info__name input' type="text" placeholder='Номер телефона'
            ...
            <div className="content__items">
                {item.map(({imageUrl, price, title, id}) => <div className="cart__item">
                        ...
                        <div className="cart__item-remove" onClick={() => filterItem(id)}>
            ...
            <div className="cart__bottom">
                ...
                <div className="cart__bottom-buttons">
                    ...
                    <div className="button pay-btn" onClick={() => FetchData()}>
